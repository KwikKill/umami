export const labels: Record<string, string> = {
  ...
  addAnnotation: 'label.add-annotation',
  apiKeys: 'label.api-keys',
  createApiKey: 'label.create-api-key',
  rotateApiKey: 'label.rotate-api-key',
  rotate: 'label.rotate',
  permissions: 'label.permissions',
  apiKeyPermissionRead: 'label.api-key-permission-read',
  apiKeyPermissionWrite: 'label.api-key-permission-write',
...
export const messages: Record<string, string> = {
  ...
  apiKeyRotatedDescription: 'message.api-key-rotated-description',
  confirmRotateApiKey: 'message.confirm-rotate-api-key',
